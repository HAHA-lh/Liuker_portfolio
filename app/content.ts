...
export const projects: Project[] = projectRows.map((row) => {
  ...
  return {
    ...
    summary: { zh: row.summaryZh || template.summary.zh, en: row.summaryEn || template.summary.en },
    challenge: { zh: row.challengeZh || template.challenge.zh, en: row.challengeEn || template.challenge.en },
